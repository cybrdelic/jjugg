...
export const applications: Application[] = [
    {
        ...
        bonus: '20% Annual + Stock Options',
        benefits: ['Health Insurance', 'Dental', 'Vision', '401k with 6% match', 'Unlimited PTO', 'Gym Membership'],
    ...
    },
    {
        ...
        bonus: '15% Annual',
        benefits: ['Health Insurance', 'Dental', 'Vision', '401k with 4% match', 'Paid Parental Leave'],
        location: 'Redmond, WA',
        remote: true,
    ...
    },
    {
        ...
        bonus: '25% Annual + Sign-on Bonus',
        benefits: ['Health Insurance', 'Dental', 'Vision', '401k with 5% match', 'Employee Discount', 'Relocation Package'],
        location: 'Seattle, WA',
        remote: true,
