...
export function VirtualizedApplicationsTable({
    ...
    // Debug logging
    console.log('VirtualizedApplicationsTable - applications.length:', applications.length);
    console.log('VirtualizedApplicationsTable - enableVirtualization:', enableVirtualization);
    console.log('VirtualizedApplicationsTable - containerHeight:', containerHeight);
    ...
    const renderTableBody = () => {
        console.log('VirtualizedApplicationsTable renderTableBody - enableVirtualization:', enableVirtualization);
        console.log('VirtualizedApplicationsTable renderTableBody - applications.length:', applications.length);

        if (!enableVirtualization || applications.length <= 50) {
            console.log('VirtualizedApplicationsTable - using normal rendering');
    ...
    return (
        <div className="professional-table-container">
            <div className="professional-table-card" ref={tableRef}>
                ...
                <div
                    ...
                    style={{
                        maxHeight: enableVirtualization && applications.length > 100 ? '600px' : 'calc(100vh - 300px)',
                        overflowY: 'auto'
                    }}
                >
                    {renderTableBody()}
        ...
        /* All other styles inherited from ApplicationsTable */
        .professional-table-container {
          width: 100%;
          max-width: 100%;
          overflow: hidden;
