...
const ApplicationDetailModal: React.FC<ApplicationDetailProps> = ({
  id,
  position,
  company,
  dateApplied,
  ...
  return (
    <div
      className={`application-modal-container ${mounted ? 'visible' : ''} ${isClosing ? 'closing' : ''}`}
      onClick={handleClose}
    >
      <div
        className={`application-modal ${mounted ? 'visible' : ''}`}
      ...
      <style jsx>{`
        ...
        .application-modal-container.closing {
          opacity: 0;
        }
